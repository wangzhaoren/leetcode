...
class XET(object):
    APPID = 'app38vQbhh13697'  # APPid
    XIAOEID = '1f4fc3a8216a1a6558ccfd82bd9a54b9'  # Cookie XIAOEID
    RESOURCEID = 'v_5c7fc795c4807_1XuQzLEa'  # ResourceID，这里的resourceid代表课程id
    sessionid = ''  # Cookie laravel_session
    session = Session()
    header = {
